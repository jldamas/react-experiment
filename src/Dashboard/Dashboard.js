        ...
        <ThemeProvider theme={darkTheme}>
            <div className={classes.root}>
                ...
                <main className={classes.content}>
                    ...
                    {component === 'dataSets' ? <DataSets/> : component === 'models' ? <ModelGenerate/> : component ===
                    'apis' ? <Apis/> : <DataSets/>
                    }
